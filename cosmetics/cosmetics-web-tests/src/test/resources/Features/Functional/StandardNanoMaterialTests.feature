...
Then I should see "Is the product intended to be rinsed off or left on?"

@nano-material @regression
Scenario: Verify how user is exposed to nano-material question
When I click "Rinsed off"
...
And I click on continue
Then I should see "List the nanomaterials in the product"
...
And I click on continue
Then I should see annexes regulation "Is test listed in EC regulation 1223/2009, Annex 4?"
...
And I click on continue
Then I should see annexes regulation "Is test listed in EC regulation 1223/2009, Annex 5?"
